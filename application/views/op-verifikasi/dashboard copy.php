                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-12">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Semua Data Siswa <?= $ses_kompetensi; 
                                                var_dump($ses_kompetensi);
                                                ?></span>
                                                <h4 class="mb-1">
                                                    <p><span class="counter-value" data-target="<?= $count ?>"></span> 
                                                   </p>
                                                </h4>
                                            </div>
