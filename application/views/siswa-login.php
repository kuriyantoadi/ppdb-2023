                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.php" class="d-block auth-logo">
                                            <img src="assets/images/logo-sm.svg" alt="" height="28"> <br>
                                            <span class="logo-txt">PPDB SMKN 1 Kragilan</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <form class="custom-form mt-4 pt-2" action="" method="post">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nisn" placeholder="Masukan NISN" name="nisn" value="">
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="">
                                                            <a href="auth-recoverpw.php" class="text-muted">Lupa Sandi?</a>
                                                        </div>
                                                    </div>
                                                </div>
